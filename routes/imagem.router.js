/********************************************************************
 * Objetivo: Arquivo responsável pela organização de rotas da imagem.
...
router.post('/', bodyParserJSON, async function (request, response) {
    ...
    let result      = await controllerImagem.inserirNovaImagem(dados, contentType)
...
router.get('/', async function (request, response) {
    let result = await controllerImagem.listarImagem()
...
router.get('/:id', async function (request, response) {
    ...
    let result = await controllerImagem.buscarImagem(id)
...
router.put('/:id', bodyParserJSON, async function (request, response) {
    ...
    let id          = request.params.id
    let dados       = request.body
    let result      = await controllerImagem.atualizarImagem(dados, id, contentType)
...
router.delete('/:id', async function (request, response) {
    let id     = request.params.id
    let result = await controllerImagem.excluirImagem(id)
