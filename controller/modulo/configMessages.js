...
const ERROR_UNAUTHORIZED               = { "status": false, "status_code": 401, "message": "Não foi possível garantir a permissão do usuário devido a invalidade de dados." }
const ERROR_NOT_FOUND                  = { "status": false, "status_code": 404, "message": "Não foi possível encontrar dados para retorno." }
const ERROR_CONFLICT                   = { "status": false, "status_code": 409, "message": "Não foi possível prosseguir com a requisição devido a um conflito com o estado atual do servidor." }
